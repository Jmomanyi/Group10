...
class client(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            print(self.username + " has joined the server" + " with the nickname " + self.nickname)
                ...
                for line in message.splitlines():
                    ...
                    if(messageParsed[0] == "JOIN"):
                        ...
                        if (found):
                            ...
                            inforserver = "NICK: " + self.nickname + " USERNAME: " + self.username + ' @ ' + self.addr[0] + '\n' + platform.node() + ' JOINED ' + channel + '\n'
                            ...
                            REPLY = ':' + self.nickname + "!" + self.username + '@' + platform.node() + ' ' + line + '\n'
                    ...
                    if(messageParsed[0] == "PART"):
                        if(self.channel):
                            channel = messageParsed[1]
                            message = ':' + self.nickname + "!" + self.username + '@' + platform.node() + ' ' + line + '\n'
